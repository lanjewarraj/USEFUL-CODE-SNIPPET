...
function smtpmailer($to, $from, $from_name, $subject, $body)
    {
        ...
        $mail->SMTPSecure = 'ssl'; 
        $mail->Host = 'Enter hostname';
        $mail->Port = 465;  
        $mail->Username = 'Enter Cpanel Email Address';
...
$result = "<div class='alert alert-danger alert-dismissible'>
   ...
   <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>Please Check Your Email Inbox or Spam folder!</div>";
    ...
    $msg = '
        ...
        <a href="http://localhost/youtube/resetPassword.php?code='.$code.'"> Reset</a><br><br>
        or copy and paste the link below in a new tab <br><br>
            
              http://localhost/youtube/resetPassword.php?code='.$code.' <br><br>
