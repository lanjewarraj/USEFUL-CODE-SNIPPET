            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="footer-widget mb-70">
                        <!-- Logo -->
                        <a href="index.php" class="foo-logo d-block mb-4"><img src="img/core-img/logo2.png" alt=""></a>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Learn and Earn With Passion <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">9jaEarn</a>
