   ...
   <?php include ("headprofile.php"); ?>
    ...
    <div class="bg-dark border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
		  ...
		  <a href="withdraw.php" class="list-group-item text-white list-group-item-action bg-dark">Withdraw</a>
        <a href="activation.php" class="list-group-item text-white list-group-item-action bg-dark">Account Activation</a>
       	<a href="#" class="list-group-item text-white list-group-item-action bg-dark"> 
	Earning( &#8358; <?php echo number_format($usersData ['earning']); ?> )</a>
